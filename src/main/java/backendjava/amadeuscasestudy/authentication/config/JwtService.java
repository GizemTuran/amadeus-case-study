...
public class JwtService {
    ...
    private static final String SECRET_KEY = "2ba87ba77edb4909d5d49c622a6e9a360311a7e8ae81f95763ddf77dbda4fce8";
    ...
    public String generateToken( //checks expiration date and validation toke valid or not
